...
export default function RegisterPage() {
	...
	return (
		<div className="relative min-h-screen overflow-hidden bg-[#0a0a0a] text-[#e5e5e5]">
			<div className="pointer-events-none absolute -top-32 right-[-5%] h-72 w-72 rounded-full bg-[#d97706]/20 blur-3xl" />
			<div className="pointer-events-none absolute bottom-[-20%] left-[-10%] h-96 w-96 rounded-full bg-[#f59e0b]/15 blur-3xl" />
			...
			<div className="relative mx-auto flex min-h-screen w-full max-w-5xl flex-col items-center justify-center gap-10 px-6 py-16 lg:flex-row">
				<section className="flex max-w-xl flex-col gap-6">
					...
					<h1 className="text-4xl font-semibold leading-tight md:text-5xl">
						Start fresh.
						<span className="block bg-gradient-to-r from-[#f59e0b] to-[#d97706] bg-clip-text text-transparent">Build a rhythm that lasts.</span>
					</h1>
					<p className="text-base leading-7 text-gray-400">
						Create an account with your Gmail address to keep tasks in one calm place and pick up anywhere.
					</p>
				...
				<section className="w-full max-w-md rounded-3xl border border-[#2a2a2a] bg-[#1a1a1a]/80 p-8 shadow-[0_30px_80px_-50px_rgba(245,158,11,0.3)] backdrop-blur">
					...
					<form className="mt-8 space-y-5" onSubmit={handleSubmit}>
						<div className="space-y-2">
							<label className="text-sm font-medium text-gray-300">Gmail Address</label>
							<input
								type="email"
								name="email"
								required
					...
					<p className="mt-6 text-center text-sm text-gray-400">
						...
						<Link href="/login" className="font-semibold text-[#f59e0b] hover:text-[#d97706]">
							Sign in
						</Link>
					</p>
				</section>
